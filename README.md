...
* **Animated Pack-a-Punch Camo:** Applies the Ezz galaxy animated camo to Pack-a-Punched guns on **Mob of the Dead, Buried and Origins**, and to the guns this mod adds on every map. Switch it off and each map shows its own stock Pack-a-Punch camo. *Green Run, Die Rise and Nuketown cannot show it:* a map's own camo tables override the mod's, and those three ship 4-, 7- and 4-slot tables that have no animated entry at all, so their Pack-a-Punch camo stays the stock one.
