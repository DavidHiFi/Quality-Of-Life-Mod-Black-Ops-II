...
Almost all Campaign weapon, and every single Multiplayer weapon in the Mystery box, 4 wonder weapons ported straight from the unreleased DLC5, bonus Survival maps, and a user-friendly Settings menu that you can configure to your hearts content in-game.
...
* **Instant Pack-a-Punch:**
  * Instant Pack-a-Punch, like in Call Of Duty: Black Ops Cold War - Zombies. Can be turned on or off in the settings menu.
...
This mods code is mostly made using **Claude Code AI**, however **ANY** and **ALL** artwork is human-made. I understand how controversial the usage of AI in any form is perceived, as such I understand that this will come as a disappointment to some, and any criticism is understandable - I am not a coder, nor have I ever claimed to be. This projects initial intention was to be used by myself, and myself only. I have decided to open this project up as I understand that this could be quite resourceful.
<div align="center">
<br>
