...
struct_class_init()
{
	...
	// zm_qol diagnostic marker - confirms the struct_class_init replaceFunc took and
	// shows which gametype+location pair the struct_init lookup is about to use.
	println( "[zm_qol] struct_class_init - gametype=" + gametype + " location=" + location );
