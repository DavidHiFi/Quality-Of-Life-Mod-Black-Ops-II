...
//  3. Adds add_adjacent_zone( "zone_dock", "zone_dock_puzzle",
//     "docks_inner_gate_unlocked" ) unconditionally, replacing stock's
//     classic-only zone_dock_puzzle -> zone_dock_puzzle edge. Docks' loc script
//     sets that flag when the inner gate is bought.
//
